...
abstract class Generator
{
    ...
    {
        $path = config('generators.generator.stubsOverridePath', __DIR__);
    ...
    public function getConfigGeneratorClassPath($class, $directoryPath = false)
    {
        switch ($class) {
            ...
            case ('controllers' === $class):
                $path = config('generators.generator.paths.controllers', 'Http\Controllers');
                break;
            case ('resources' === $class):
                $path = config('generators.generator.paths.resources', 'Http\Resources');
                break;
